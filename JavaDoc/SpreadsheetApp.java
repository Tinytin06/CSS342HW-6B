...
public class SpreadsheetApp {
    ...
    /**
     * Displays the prompts and options to the user. First, prompts the user
     * to input the size of the spreadsheet, then a list of options will be
     * displayed to the user. The program will keep running until
     * the user inputs 'q' into the console.
